...
void _backspace();
// function to implement scrolling
void _scroll_down_(char* video_addr);
// puts to check for new line instead of null char
int32_t my_puts(int8_t* s, int32_t nbytes);
// strcpy to check for new line instead of null char
int8_t* my_strcpy(int8_t* dest, const int8_t*src);
// strlen to check for new line instead of null char
uint32_t my_strlen(const int8_t* s);
// function to update cursor position
void update_cursor();
// function to update cursor to specific location
void update_cursor_(int x, int y);
//function to return x cordinate
int x_screen_return();
//function to return y cordinate
int y_screen_return();
//function to set the x cordinate
void x_set_screen(int x);
//function to set the y cordinate
void y_set_screen(int y);
//modified putc
void my_putc(uint8_t c);
//function to scroll down
void _scroll_down();
//modified putc for terminals
void key_putc(uint8_t c);

/* Will print up until 32 chars on a string */
int32_t fs_printf(int8_t *format, ...);
/* Modified to only print up to null or 32 char */
